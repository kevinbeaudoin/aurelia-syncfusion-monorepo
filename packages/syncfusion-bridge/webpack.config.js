...
module.exports = ({production, server, extractCss, coverage, analyse} = {}) => ({
  resolve: {
    extensions: ['.ts', '.js'],
    modules: [srcDir, 'node_modules'],
  },
  entry: {
    app: ['aurelia-bootstrapper', './src/style/genius-ui-component.scss'],
    vendor: ['bluebird'],
  },
  output: {
    path: outDir,
  ...
  plugins: [
    ...when(analyse, new BundleAnalyzerPlugin({
      analyzerMode: 'static',
      reportFilename: 'webpackStats/report.html',
      openAnalyzer: false
    })),
    new AureliaPlugin(),
    new ProvidePlugin({
